          ...
          <main class="w-full max-w-md mx-auto p-6">
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div class="p-4 sm:p-7">
                ...
                <!-- Form -->
                <form wire:submit.prevent ='validates'>
                  <div class="grid gap-y-4">
                    <div>
                      ...
                      <div>
                        @if(session('success'))
                        <p class="text-xs text-red-600 mt-2" id="email-error">{{ session('success') }}</p>
                        @endif
                    </div>
                      @error('email')
                    ...
                    <div>
                      <div class="flex justify-between items-center">
                        ...
                        <a wire:navigate class="text-sm text-blue-600 decoration-2 hover:underline
                        font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot">Forgot password?</a>
                      </div>
                      <div class="relative">
